                    ...
                    <div className="kpi-item" style={{ textAlign: 'center', borderLeft: '1px solid #e2e8f0', padding: '0 0.5rem', position: 'relative' }}>
                      {showClusterInfo ? (
                        <div style={{ fontSize: '0.9rem', color: '#475569', lineHeight: '1.5', textAlign: 'right', paddingRight: '1rem' }}>
                          ...
                          נתון זה מצביע על אזור המיקוד המרכזי שבו פעלת לאחרונה, מתוך 5 האשכולות למצוינות ארגונית. המערכת מזהה לאיזה אשכול שייכים הכלים שתרגלת הכי הרבה פעמים בשיחות שלך. במבט מהיר תראה היכן מושקעת עיקר האנרגיה הניהולית והאסטרטגית שלך בתקופה זו.<br/>
