                    ...
                    <div className="kpi-item" style={{ textAlign: 'center', borderLeft: '1px solid #e2e8f0', padding: '0 0.5rem', position: 'relative' }}>
                      {showInfo ? (
                        <div style={{ fontSize: '0.82rem', color: '#475569', lineHeight: '1.4', textAlign: 'right', paddingRight: '1rem' }}>
                          ...
                          כשאתה מעלה אתגר או דילמה, המטרה היא לא רק לתת עצה, אלא לצייד בשיטת עבודה והתכוונות מערכתית. המנטור חושף בפניך כלי ניהולי (כמו מודל RADAR, אדרת הדג) ומדריך אותך. כך אתה מתרגל חשיבה ניהולית-אסטרטגית חדשה.
                        </div>
                      ) : (
                        <>
