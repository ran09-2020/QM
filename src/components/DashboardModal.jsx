                    ...
                    <div className="kpi-item" style={{ textAlign: 'center', borderLeft: '1px solid #e2e8f0', padding: '0 0.5rem', position: 'relative' }}>
                      {showClusterInfo ? (
                        <div style={{ fontSize: '0.82rem', color: '#475569', lineHeight: '1.4', textAlign: 'right', paddingRight: '1rem' }}>
                          ...
                          נתון זה חושף את אזור המיקוד המרכזי שבו פעלת לאחרונה, מתוך 5 האשכולות למצוינות ארגונית. המערכת מזהה לאיזה אשכול שייכים הכלים שתרגלת הכי הרבה פעמים בשיחות שלך, ומציגה אותו כאן. כך תוכל לראות במבט מהיר היכן מושקעת עיקר האנרגיה הניהולית והאסטרטגית שלך בתקופה זו. לחשיבה: האם זה ניווט מכוון או מקרי?
                        </div>
                      ) : (
                        <>
